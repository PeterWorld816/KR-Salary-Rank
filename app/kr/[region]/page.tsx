...
// — a slug for a "준비중" province (e.g. /kr/busan) isn't a real page yet, so
...
export function generateMetadata({ params }: { params: Params }): Metadata {
  ...
  return {
    title,
    description,
    alternates: { canonical: absoluteUrl(`/kr/${sido.slug}`) },
    openGraph: { title, description, url: absoluteUrl(`/kr/${sido.slug}`), locale: "ko_KR", type: "website" },
  };
}
