...
export const translations: Record<LangCode, Translations> = {
  ...
  en: {
    ...
    krAppTitle: "What's Your Korean Income Percentile?",
    krTagline: "Enter your annual income, then pick a province and district on the map to see how you compare against the local average",
    krMastheadTagline: "Where do you stand locally?",
    krDisclaimer: "Based on National Tax Service (국세청) tax-statistics regional averages — actual figures may differ from your real income. Not financial advice.",
    krInputTitle: "Your info",
    krGroupWho: "Who are you?",
    krGroupMoney: "Your income",
    krFieldGender: "Gender",
    krFieldMarital: "Marital status",
    krFieldAgeBand: "Age band",
    krFieldIncome: "Pre-tax annual income (10,000 KRW)",
    krComingSoonBadge: "Coming soon",
    krDemographicComingSoonNote: "No regional breakdown by gender, marital status, or age exists yet, so only the region-average comparison is available for now.",
    krApply: "Apply & view map",
    krMapTitle: "Select a province",
    krMapHint: "Pick a province on the map or list to see its district-level list",
    krLegendNoData: "No data",
    krRegionMapTitleTemplate: "Select a district in {region}",
    krRegionMapHint: "Pick a district from the list to see your result for that area",
    krSearchSidoPlaceholder: "Search provinces...",
    krSearchGuPlaceholder: "Search districts...",
    krListNoResults: "No results found",
    krBackToKrMap: "Province map",
    krPendingBadge: "Coming soon",
    krNoGuDataTitle: "No district-level data for this province yet",
    krNoGuDataDesc: "You can still see your result against this province's overall average.",
    krSeeRegionResultButtonTemplate: "See result vs. {region} average",
    krResultMissingTitle: "Pick a region on the map first",
    krResultMissingDesc: "You'll need to select a province before we can show your result (a district is optional).",
    krResultMissingCta: "Choose on the map",
    krNationalLabel: "Nationwide",
    krSidoLabel: "Province",
    krGuLabel: "District",
    krRatioHeroLabelTemplate: "vs. {region} average",
    krRatioAboveTemplate: "{percent}% above average",
    krRatioBelowTemplate: "{percent}% below average",
    krRatioEqualText: "Right at the average",
    krEstimatedPercentileLabel: "Estimated income percentile",
    krEstimatedPercentileDisclaimer: "This is not real National Tax Service percentile data — it's an estimate assuming a log-normal distribution around the region's average.",
    krMeanLabel: "This region's average annual income",
    krCompareChartTitle: "Compare at a glance",
    krSourceLabelTemplate: "Source: National Tax Service tax statistics 4.2.15, income tax year-end settlement filings by district ({asOf})",
    krSeeFullBreakdown: "See full breakdown",
    krDetailsToggleShow: "See full breakdown",
    krDetailsToggleHide: "Hide full breakdown",
    krResultDashboardIntro: "See how your income compares to the nationwide, provincial, and district averages — all in one place.",
    krDashboardIncomeSectionTitle: "Income comparison",
  },
};
